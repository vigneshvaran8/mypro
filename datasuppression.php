<?php $pageTitle = 'Data Suppression'; ?>
<?php require "includes/header.php"; ?>
<?php
switch ($_GET['message'])
{
    case 'success':
        $message = 'Data Suppressed successfully and transfered to the selected server.';
        $msgClass = 'alert alert-success';
        break;
    case 'outputfileempty':
        $message = 'Output File name should not be empty.';
        $msgClass = 'alert alert-danger';
        break;
    case 'filepathempty':
    	$message = 'Data File or Suppression File or Destination File Path is empty. Please contact the admin.';
        $msgClass = 'alert alert-danger';
        break;
    case 'filenotexists':        
    	$message = 'Suppression File or Data File you have entered not exists in the server.';
        $msgClass = 'alert alert-danger';
        break;
	case 'serverempty':        
    ...
    case 'serverloginfailed':        
        ...
        $msgClass = 'alert alert-danger';
        break;
    case 'hostfilewriteaccessdenied':        
    	$message = 'Not able to create datafile in our server. Please contact the admin to set full permission for download data folder.';
        $msgClass = 'alert alert-danger';
        break;
    case 'datatransferfailure':    
        $message = 'Not able to transfer suppressed data to the server. Please check if the datafile folder is created in the server selected.';
        $msgClass = 'alert alert-danger';
        break;
}
?>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                        <form id="configuration-form" action="<?php echo SITE_URL.'datasuppressionpost.php' ?>" method="post" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group" id="campaign-container" style="display: none">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" onchange="getSuppressionfileofcampaign(this);" name="campaign_id" id="campaign-id" data-live-search="true">
                            ...
                            <div class="form-group" id="datafile-container" style="display: none">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="datafile" id="datafile" data-live-search="true" onchange="getNumberoflinesdatafile(this);">
                                        <option value="">Choose Data File</option>
                                    </select>
                                </div>
                                No of Lines: <input type="text" id="datafile-lines" readonly="" value="0">
                            </div>
                            <input type="hidden" name="employee_id" id="employee_id" value="<?=getUseremployeeid() ?>">
                            <input type="hidden" name="current_date" id="current_date" value="<?=date('dmy',time()) ?>">
                            <div class="form-group">
